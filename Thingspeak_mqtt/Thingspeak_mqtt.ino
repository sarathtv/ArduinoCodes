...
char ssid[] = "Uptown";
char pass[] = "sarath5257";
// Ensure that the credentials here allow you to publish and subscribe to the ThingSpeak channel.
#define channelID 1081891
const char mqttUserName[] = "FzcYMwkHCCYQIy0dIgkqHjI"; 
const char clientID[] = "FzcYMwkHCCYQIy0dIgkqHjI";
const char mqttPass[] = "7zZHzCzCMk1EaPTTEzgETPOw";
